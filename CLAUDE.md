...
- **দুই পাতা আলাদা:** `readNID(file,{back:true})` → শুধু ঠিকানা/রক্ত/জন্মস্থান (+MRZ থেকে NID/DOB)। **পিছনের পাতা কখনো নাম/পিতা/মাতা দেবে না** — আগে ঠিকানার লাইন নাম হিসেবে ঢুকে ভালো তথ্য মুছে দিত। `looksLikeBackPage()` নিজেও পাতা চিনতে পারে।
- **MRZ পার্সার** (`KHOCR.parseMRZ`) পিছনের পাতার মেশিন-লাইন থেকে NID ও জন্ম তারিখ নিখুঁতভাবে পড়ে — এটিই সর্বোচ্চ অগ্রাধিকার পায়।
- **লেবেল মেলানো:** edit-distance, থ্রেশহোল্ড **০.৭৫**, লেবেল প্রার্থীর দৈর্ঘ্য ≤ target+1 — নাহলে "মমতাজ"-কে "মাতা" লেবেল ভেবে ভুল হয়। ভাঙা লাইন জোড়া দেওয়া হয় (এ,কে,এম + আসাদুজ্জামান · মমতাজ + বেগম)। একক অক্ষরও নামের অংশ হিসেবে রাখা হয়।
- পরীক্ষা: আসল কার্ড ১৫/১৫ ও পুরনো ৫টি নমুনা ১৫/১৫ (১০০%)।
